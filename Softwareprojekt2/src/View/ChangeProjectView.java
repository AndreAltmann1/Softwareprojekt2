...
//Fenster zum ändern eines Projektes
public class ChangeProjectView extends JFrame {
	...
	public ChangeProjectView(JTable table) {
		...
		//Values des ausgewählten Projektes
		...
		JButton btnChangeProjekt = new JButton();
		btnChangeProjekt.setIcon(iconChange);
		...
		//Values des ausgewählten Projektes in die Felder setzten
		tfName.setText(name);
		...
		btnChangeProjekt.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (tfName.getText().equals("")) {
					...
					ProjectModel.changeProject(prj, tfName.getText(), (Customer) cbCustomer.getSelectedItem(),
							cbZweck.getSelectedItem().toString());
					dispose();
				}
